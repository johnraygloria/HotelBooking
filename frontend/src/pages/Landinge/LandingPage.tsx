 ...
 navigate("/LandingPage/login"); 
    ...
    return (
      <div className="relative min-h-screen flex items-center justify-center text-white px-6">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_black,_#7f1d1d,_black)] opacity-90 animate-interstellarPulse "></div>
        <div className="relative z-10 flex flex-col items-center text-center max-w-4xl">
          ...
          <button className="bg-[radial-gradient(circle_at_top,_black,_#7f1d1d,_black)] cursor-pointer opacity-90 px-6 py-3 rounded-lg text-lg font-semibold transition duration-300 "
